...
class SpeciesConvNeXtSmallTrainer:
    ...
    def _final_evaluation(self, model, loader, true_labels):
        ...
        plt.ylabel('True')
        plt.title('Species Confusion Matrix (ConvNeXt-Small)')
        plt.xticks(rotation=45, ha='right')
        plt.tight_layout()
        
        save_path = os.path.join(self.config['model_dir'], 'species_convnextsmall_confusion_matrix.png')
    ...
    def plot_history(self):
        ...
        save_path = os.path.join(self.config['model_dir'], 'species_convnextsmall_training_history.png')
        plt.savefig(save_path, dpi=150)
