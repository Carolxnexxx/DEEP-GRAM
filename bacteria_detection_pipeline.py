...
CONFIG = {
    ...
    'save_overlays': True,
    'save_masks': False,
    'max_crops_per_slide': 50000,
    'max_overlays_per_slide': 10,
    'min_storage_gb': 20,
    'delete_after_processing': False,
    'overwrite_existing': True,

    'filter_debris': True,
    'debris_model_path': r"C:\Gram Stain Training Data\models\debris_filter_20260227_180942.pth",
    'debris_threshold': 0.7,
...
def extract_detections(tile_rgb, mask, tile_coords, config):
    ...
    for region in regions:
        ...
        detection = {
            'bbox_local': (min_col, min_row, max_col, max_row),
            'bbox_global': (global_x, global_y, global_x + (max_col - min_col), global_y + (max_row - min_row)),
            'centroid_local': (region.centroid[1], region.centroid[0]),
