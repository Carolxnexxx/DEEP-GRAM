...
class SpeciesConvNeXtSmallTrainer:
    ...
    def __init__(self, config):
        ...
        mapping_path = os.path.join(config['model_dir'], 'gram_pos_clusters_label_mapping.json')
    ...
    def _final_evaluation(self, model, loader):
        ...
        save_path = os.path.join(self.config['model_dir'], 'gram_pos_cocci_clusters_confusion_matrix.png')
    ...
    def plot_history(self):
        ...
        save_path = os.path.join(self.config['model_dir'], 'gram_pos_clusters_training_history.png')
        plt.savefig(save_path, dpi=150)
